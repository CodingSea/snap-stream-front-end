...
async function getFollowingsNumber()
{
    try
    {
        const token = localStorage.getItem("token");
        ...
        const res = await axiosInstance.get(`${ import.meta.env.VITE_BACKEND_URL }/user/${ decodedToken.user_id }/followings/`)
...
async function getProfileFollowingsNumber(id)
{
    try
    {
        const res = await axiosInstance.get(`${ import.meta.env.VITE_BACKEND_URL }/user/${ id }/followings/`)
...
async function getFollowersNumber(id)
{
    try
    {
        const res = await axiosInstance.get(`${ import.meta.env.VITE_BACKEND_URL }/user/${ id }/followers/`)
